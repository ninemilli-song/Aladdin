...
@connect(
    store => {
        return {
            visible: store.Home.getIn(['uistate', 'qDetailDialogOpts', 'visible']),
            loading: store.Home.getIn(['uistate', 'qDetailDialogOpts', 'loading']),
            replyQuestionExpand: store.Home.getIn(['uistate', 'qDetailDialogOpts', 'replyQuestionExpand']),
            id: store.Home.getIn(['selectedQId']),
            data: store.Home.getIn(['qDetailData'])
        }
    },
    dispatch => {
        return {
