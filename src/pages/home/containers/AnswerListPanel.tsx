...
@connect(
    (store, ownProps) => {
        ...
        const data = store.Home.get('qExpandQuestions').get(questionId).get('data');
        const replyExpand = store.Home.get('qExpandQuestions').get(questionId).getIn(['uistate', 'replyExpand']);
        const loading = store.Home.get('qExpandQuestions').get(questionId).getIn(['uistate', 'loading']);
